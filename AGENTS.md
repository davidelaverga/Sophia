...
- **Clean code is enforced, not requested.** `pnpm check` runs Prettier and type-aware oxlint before typecheck and tests. Follow [CONTRIBUTING.md](CONTRIBUTING.md); fix findings instead of suppressing them.
